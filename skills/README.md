...
`teach` is installed from Matt Pocock's upstream source. A similar system (but not just a skill) lives in the separate OpenCode Learn plugin and `/learn` command documented in [`../plugins/learn/README.md`](../plugins/learn/README.md).
